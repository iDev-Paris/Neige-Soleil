...
<body>
        ...
        <div class="container-contact100">
                <div class="wrap-contact100">
                        ...
                        <form class="contact100-form validate-form" action="img_post.php" method="post" autocomplete="off">
                                <span class="contact100-form-title">IMAGES</span>
					...
					<span class="focus-input100"></span>
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Valid dateD is required: ex@abc.xyz">
                                        ...
                                        <select class="input100" name="idhab" id="idhab">
                                                ...
                                                foreach ($habitations as $unehabitation) {
                                                        echo "<option value='" . $unehabitation['idhab'] . "'>" . $unehabitation["nom"] . "</option>";
                                                }
                                                ?>
                                        </select>
                                        <span class="focus-input100"></span>
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Valid dateD is required: ex@abc.xyz">
                                        <span class="label-input100">Image here !</span>
                                        <input class="input100" type="text" name="url_im" id="url_im" placeholder="put your picture here" required>
                                        <span class="focus-input100"></span>
                                </div>
